...
//                if(driver.setMotorPosition(motorInfo, 100)) {
...
//            dxl_comm_result = packetHandler->ping(portHandler, DXL_ID, &dxl_error);
//            if(dxl_comm_result != COMM_SUCCESS) {
//                packetHandler->printTxRxResult(dxl_comm_result);
//            } else if(dxl_error != 0) {
//                packetHandler->printRxPacketError(dxl_error);
//            } else {
//                ROS_INFO("[%s]: Motor ID: %d is visible on baudrate %d", ros::this_node::getName().c_str(), DXL_ID, BAUDRATE);
//                dxl_comm_result = packetHandler->read2ByteTxRx(portHandler, DXL_ID, ADDR_MX_MODEL_NUM, &dxlModelNum, &dxl_error);
//                if(dxl_comm_result != COMM_SUCCESS) {
//                    packetHandler->printTxRxResult(dxl_comm_result);
//                } else if(dxl_error != 0) {
//                    packetHandler->printRxPacketError(dxl_error);
//                } else {
//                    ROS_INFO("[%s]: Motor ID: %d, model: %d", ros::this_node::getName().c_str(), DXL_ID, dxlModelNum);
//
//                    // Enable Dynamixel Torque
//                    dxl_comm_result = packetHandler->write1ByteTxRx(portHandler, DXL_ID, ADDR_MX_TORQUE_ENABLE,
...
//                        packetHandler->printRxPacketError(dxl_error);
//                    } else {
//                        ROS_INFO("[%s]: Motor ID: %d is torque", ros::this_node::getName().c_str(), DXL_ID);
//                        return true;
//                    }
//                }
//            }
